    ...
    <v-row v-bind:class="{ 'mb-2': !section.MA_EMA_ADX.display }">
      <v-app-bar dense>
        ...
        <v-btn
          ...
          icon
          @click="section.MA_EMA_ADX.display = !section.MA_EMA_ADX.display"
        >
    ...
    <v-row>
      <v-app-bar dense>
        ...
        <v-btn
          ...
          icon
          @click="section.RSI_MACD.display = !section.RSI_MACD.display"
        >
      ...
      axios
        ...
        .then((response) => {
          ...
          data.buyRecommendations.forEach((stock, i) => {
            ...
            data['buyRecommendations'][i].reverse_RSI = ten_reverse_RSI.map(
              (n) => n.toFixed(2)
            )
            data['buyRecommendations'][i].reverse_ADX = ten_reverse_ADX.map(
              (n) => n.toFixed(2)
            )
